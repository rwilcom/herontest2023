...
public class KryoSerializer implements IPluggableSerializer {
  ...
  private Kryo getKryo() {
    ...
    k.register(String.class, new DefaultSerializers.StringSerializer());
    k.register(Integer.class, new DefaultSerializers.IntSerializer());
    k.register(Double.class, new DefaultSerializers.DoubleSerializer());
    
    //register all types being used in the tuple
